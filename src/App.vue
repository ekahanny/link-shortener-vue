<template>
  <div class="container h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col col-xl-10">
        ...
        <p id="desc" class="text-center fst-italic mb-4">
          The modern, advanced, and privacy-aware URL Shortener built with Vue &
          Bootstrap
        </p>
    ...
    <div class="custom-shape-divider-bottom-1711470625">
      <svg
        data-name="Layer 1"
...
.custom-shape-divider-bottom-1711470625 {
  position: absolute;
  bottom: 0;
  left: 0;
  width: 100%;
...
.custom-shape-divider-bottom-1711470625 svg {
  position: relative;
  display: block;
...
.custom-shape-divider-bottom-1711470625 .shape-fill {
  fill: #739edd;
}
</style>
